<?php 
 ...
 <?php  $mobile = $this->input->get('mobile');             
 if($_SESSION['Level'] == 'Officer' && $mobile == ''){ //? ถ้า mobile เป็นค่าว่างแสดงว่าผู้ใช้อยู่ในหน้า index/check หน้าเริ่มต้นของ pc จะต้องโดนเช็ค
      ?> 
        //? บังคับให้มือถือ Redirect
        function detectmob() {
            if(window.innerWidth <= 800 && window.innerHeight <= 600) {return true;} else {return false;}
        }
        if (detectmob()){
            top.location.href="check?mobile=1";
        }

 <?php } 
 if($_SESSION['Level'] == 'Officer' && $mobile != ''){ //? ถ้า mobile ไม่เป็นค่าว่างแสดงว่าผู้ใช้อยู่ในหน้าของ mobile แล้ว หรือไม่ก็หน้าของ pc ที่เอาลิงค์ mobile มา เราจะต้องเช็คว่า pc เปิดลิงค์ mobile อยู่หรือเปล่า ถ้าเปิดอยู่ให้ redirect ออกไป ?>

        //? บังคับให้ pc Redirect
        function detectpc() {
            if(window.innerWidth > 800 && window.innerHeight > 600) {return true;} else {return false;}
        }
        if (detectpc()){
            top.location.href="check";
        }
 <?php } ?>
                ...
                <div class="intro-y box flex flex-col lg:flex-row mt-5">
                    ...
                    <form action="<?php echo site_url('check?mode=loginm');?>" method="POST">    
                            ...
                            <?php if($mobile == '1'){?>
                            <br><br>
                                <textarea required type="textarea" name="Time_mobile_reasonm" class="form-control form-control-user">เหตุผลที่เช็คชื่อในโทรศัพท์</textarea>
                            <?php } ?>
                            <br><br>
                    ...
                    <div class="intro-y border-b border-t lg:border-b-0 lg:border-t-0 flex-1 p-5 lg:border-l lg:border-r border-gray-200 dark:border-dark-5 py-16">
                        ...
                        <?php if($timenow > '12:50:00'){ ?>
                            ...
                            <?php if($mobile == '1'){?>
                            <br><br>
                                <textarea required type="textarea" name="Time_mobile_reasona" class="form-control form-control-user">เหตุผลที่เช็คชื่อในโทรศัพท์</textarea>
                            <?php } ?>
                            <br><br>                                       
                        ...
                        <?php if($timenow > '18:00:00'){ ?>
                            ...
                            <?php } else{ ?>                                      
                                <form action="<?php echo site_url('check?mode=logout');?>" method="POST">  
                                    ...
                                    <?php if($mobile == '1'){?>
                                    <br><br>
                                        <textarea required type="textarea" name="Time_mobile_reasonout" class="form-control form-control-user">เหตุผลที่เช็คชื่อในโทรศัพท์</textarea>
                                    <?php } ?>
                                    <br><br>
